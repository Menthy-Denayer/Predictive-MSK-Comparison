...
register(id="sconewalk_g9dof18-v1",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
             'model_file': curr_dir + '/data-v1/gait9dof18musc-H0918v3-LimF-musclePaths.scone',
             'obs_type': '2D',
             'left_leg_idxs': [3, 4, 5],
             'right_leg_idxs': [6, 7, 8],
             'clip_actions': True,
...
register(id="sconewalk_g9dof18-v2",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
             'model_file': curr_dir + '/data-v1/gait9dof18musc-H0918v3-LimF-musclePaths-damp1.scone',
             'obs_type': '2D',
             'left_leg_idxs': [3, 4, 5],
             'right_leg_idxs': [6, 7, 8],
             'clip_actions': True,
...
register(id="sconewalk_g9dof18-v3",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
             'model_file': curr_dir + '/data-v1/gait9dof18musc-H0918v3-LimF.scone',
             'obs_type': '2D',
             'left_leg_idxs': [3, 4, 5],
             'right_leg_idxs': [6, 7, 8],
             'clip_actions': True,
...
register(id="sconewalk_gait9dof18_osim-v1",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
             'model_file': curr_dir + '/data-v1/gait9dof18musc-H0918v3-LimF-musclePaths.scone',
             'obs_type': '2D',
...
# added the following 14/03/2025
register(id="sconewalk_gait9dof18musc-v1",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
             'model_file': curr_dir + '/data-v1/gait9dof18musc.scone',
             'obs_type': '2D',
             'left_leg_idxs': [3, 4, 5],
             'right_leg_idxs': [6, 7, 8],
             'clip_actions': True,
